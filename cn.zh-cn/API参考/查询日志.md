...
参数需要在调用时，放在请求body中，为JSON结构。结构可参考如下：
...
结构中的请求参数如[表2](#zh-cn_topic_0137629939_table1221212122718)所示。
...
<th class="cellrowborder" valign="top" width="9.44%" id="mcps1.2.6.1.2"><p id="zh-cn_topic_0137629939_p28021733"><a name="zh-cn_topic_0137629939_p28021733"></a><a name="zh-cn_topic_0137629939_p28021733"></a>是否必选</p>
</th>
<th class="cellrowborder" valign="top" width="11.77%" id="mcps1.2.6.1.3"><p id="zh-cn_topic_0137629939_p55167925"><a name="zh-cn_topic_0137629939_p55167925"></a><a name="zh-cn_topic_0137629939_p55167925"></a>参数类型</p>
</th>
<th class="cellrowborder" valign="top" width="16.08%" id="mcps1.2.6.1.4"><p id="zh-cn_topic_0137629939_p39416958"><a name="zh-cn_topic_0137629939_p39416958"></a><a name="zh-cn_topic_0137629939_p39416958"></a>取值范围</p>
</th>
<th class="cellrowborder" valign="top" width="42.92%" id="mcps1.2.6.1.5"><p id="zh-cn_topic_0137629939_p38656999"><a name="zh-cn_topic_0137629939_p38656999"></a><a name="zh-cn_topic_0137629939_p38656999"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="zh-cn_topic_0137629939_row44209176"><td class="cellrowborder" valign="top" width="19.79%" headers="mcps1.2.6.1.1 "><p id="zh-cn_topic_0137629939_p24173498"><a name="zh-cn_topic_0137629939_p24173498"></a><a name="zh-cn_topic_0137629939_p24173498"></a>category</p>
</td>
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0137629939_p11896308"><a name="zh-cn_topic_0137629939_p11896308"></a><a name="zh-cn_topic_0137629939_p11896308"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="zh-cn_topic_0137629939_p24076911"><a name="zh-cn_topic_0137629939_p24076911"></a><a name="zh-cn_topic_0137629939_p24076911"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0137629939_p4072787"><a name="zh-cn_topic_0137629939_p4072787"></a><a name="zh-cn_topic_0137629939_p4072787"></a>app_log、node_log、custom_log</p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><p id="zh-cn_topic_0137629939_p0203560257"><a name="zh-cn_topic_0137629939_p0203560257"></a><a name="zh-cn_topic_0137629939_p0203560257"></a>日志类型字段：</p>
...
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0137629939_p55809410"><a name="zh-cn_topic_0137629939_p55809410"></a><a name="zh-cn_topic_0137629939_p55809410"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="zh-cn_topic_0137629939_p24268355"><a name="zh-cn_topic_0137629939_p24268355"></a><a name="zh-cn_topic_0137629939_p24268355"></a>JSON结构体</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0137629939_p19579704"><a name="zh-cn_topic_0137629939_p19579704"></a><a name="zh-cn_topic_0137629939_p19579704"></a>请参考<a href="#table14552018417">表3</a></p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><p id="zh-cn_topic_0137629939_p975214717378"><a name="zh-cn_topic_0137629939_p975214717378"></a><a name="zh-cn_topic_0137629939_p975214717378"></a>日志过滤条件集合，不同日志来源所需字段不同。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0137629939_p1542262318548"><a name="zh-cn_topic_0137629939_p1542262318548"></a><a name="zh-cn_topic_0137629939_p1542262318548"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="p1907736164011"><a name="p1907736164011"></a><a name="p1907736164011"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0137629939_p98063212572"><a name="zh-cn_topic_0137629939_p98063212572"></a><a name="zh-cn_topic_0137629939_p98063212572"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><a name="zh-cn_topic_0137629939_ol105389351285"></a><a name="zh-cn_topic_0137629939_ol105389351285"></a><ol id="zh-cn_topic_0137629939_ol105389351285"><li>支持关键词精确搜索。关键词指相邻两个分词符之间的单词。</li><li>支持关键词模糊匹配搜索，例如输入“RROR”或“ERRO?”或“*ROR*”或“ERR*”或“ER*OR”。</li><li>支持短语精确搜索，例如输入“Start to refresh alm Statistic”。</li><li>支持关键词的“与”、“或”组合搜索。格式为“query&amp;&amp;logs”或“query||logs”。</li></ol>
...
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0137629939_p314616560575"><a name="zh-cn_topic_0137629939_p314616560575"></a><a name="zh-cn_topic_0137629939_p314616560575"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="p1497218452400"><a name="p1497218452400"></a><a name="p1497218452400"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0137629939_p1414616569570"><a name="zh-cn_topic_0137629939_p1414616569570"></a><a name="zh-cn_topic_0137629939_p1414616569570"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><p id="zh-cn_topic_0137629939_p18146175665710"><a name="zh-cn_topic_0137629939_p18146175665710"></a><a name="zh-cn_topic_0137629939_p18146175665710"></a>搜索起始时间（UTC时间，毫秒级）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0137629939_p63411828185915"><a name="zh-cn_topic_0137629939_p63411828185915"></a><a name="zh-cn_topic_0137629939_p63411828185915"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="p13986445124012"><a name="p13986445124012"></a><a name="p13986445124012"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0137629939_p20341122855910"><a name="zh-cn_topic_0137629939_p20341122855910"></a><a name="zh-cn_topic_0137629939_p20341122855910"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><p id="zh-cn_topic_0137629939_p193411828125917"><a name="zh-cn_topic_0137629939_p193411828125917"></a><a name="zh-cn_topic_0137629939_p193411828125917"></a>搜索结束时间（UTC时间，毫秒级）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="p29511776216"><a name="p29511776216"></a><a name="p29511776216"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="p91368229213"><a name="p91368229213"></a><a name="p91368229213"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="p176521829112117"><a name="p176521829112117"></a><a name="p176521829112117"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><p id="p1495120711213"><a name="p1495120711213"></a><a name="p1495120711213"></a>日志单行序列号，第一次查询时不需要此参数，后续分页查询时需要使用，可从上次查询的返回信息中获取。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="p133462031102315"><a name="p133462031102315"></a><a name="p133462031102315"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="p156899512214"><a name="p156899512214"></a><a name="p156899512214"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="p106891657219"><a name="p106891657219"></a><a name="p106891657219"></a>“next”</p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><p id="p106891154216"><a name="p106891154216"></a><a name="p106891154216"></a>表示此次查询为分页查询，第一次查询时不需要此参数，后续分页查询时需要使用。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="p756511501161"><a name="p756511501161"></a><a name="p756511501161"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="p11380155781615"><a name="p11380155781615"></a><a name="p11380155781615"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="p322619356169"><a name="p322619356169"></a><a name="p322619356169"></a>小于等于5000。</p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><p id="p689665482512"><a name="p689665482512"></a><a name="p689665482512"></a>表示每次查询的日志条数，不填时默认为5000，建议您设置为100。</p>
...
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0137629939_p101801250195918"><a name="zh-cn_topic_0137629939_p101801250195918"></a><a name="zh-cn_topic_0137629939_p101801250195918"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="p1011646134016"><a name="p1011646134016"></a><a name="p1011646134016"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0137629939_p3180175011598"><a name="zh-cn_topic_0137629939_p3180175011598"></a><a name="zh-cn_topic_0137629939_p3180175011598"></a>0、1</p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><p id="zh-cn_topic_0137629939_p1418095055916"><a name="zh-cn_topic_0137629939_p1418095055916"></a><a name="zh-cn_topic_0137629939_p1418095055916"></a>搜索时是否隐藏系统日志（icagent\kubectl），默认0为隐藏，1为显示。</p>
</td>
</tr>
<tr id="row1863943733911"><td class="cellrowborder" valign="top" width="19.79%" headers="mcps1.2.6.1.1 "><p id="p663993715399"><a name="p663993715399"></a><a name="p663993715399"></a>isDesc</p>
</td>
<td class="cellrowborder" valign="top" width="9.44%" headers="mcps1.2.6.1.2 "><p id="p363933733918"><a name="p363933733918"></a><a name="p363933733918"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="11.77%" headers="mcps1.2.6.1.3 "><p id="p1176815574320"><a name="p1176815574320"></a><a name="p1176815574320"></a>boolean</p>
</td>
<td class="cellrowborder" valign="top" width="16.08%" headers="mcps1.2.6.1.4 "><p id="p185451352103915"><a name="p185451352103915"></a><a name="p185451352103915"></a>true、false</p>
</td>
<td class="cellrowborder" valign="top" width="42.92%" headers="mcps1.2.6.1.5 "><p id="p1380914532467"><a name="p1380914532467"></a><a name="p1380914532467"></a>标识按照lineNum升序查询还是降序查询。</p>
<p id="p63916014717"><a name="p63916014717"></a><a name="p63916014717"></a>true：降序（lineNum由大到小：时间从新到老）。</p>
<p id="p17173114813467"><a name="p17173114813467"></a><a name="p17173114813467"></a>false：升序（lineNum由小到大：即时间从老到新）。</p>
</td>
</tr>
</tbody>
</table>
...
<a name="table14552018417"></a>
<table><thead align="left"><tr id="row195761154116"><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.6.1.1"><p id="p1853783204116"><a name="p1853783204116"></a><a name="p1853783204116"></a>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.6.1.2"><p id="p953783214119"><a name="p953783214119"></a><a name="p953783214119"></a>是否必选</p>
</th>
<th class="cellrowborder" valign="top" width="14.69%" id="mcps1.2.6.1.3"><p id="p953793218415"><a name="p953793218415"></a><a name="p953793218415"></a>参数类型</p>
</th>
<th class="cellrowborder" valign="top" width="18.3%" id="mcps1.2.6.1.4"><p id="p13537163215418"><a name="p13537163215418"></a><a name="p13537163215418"></a>取值范围</p>
</th>
<th class="cellrowborder" valign="top" width="27.01%" id="mcps1.2.6.1.5"><p id="p155375322417"><a name="p155375322417"></a><a name="p155375322417"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="row14578112417"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.1 "><p id="p194631756124118"><a name="p194631756124118"></a><a name="p194631756124118"></a>clusterId</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.2 "><p id="p646335674112"><a name="p646335674112"></a><a name="p646335674112"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="14.69%" headers="mcps1.2.6.1.3 "><p id="p8463205614412"><a name="p8463205614412"></a><a name="p8463205614412"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="18.3%" headers="mcps1.2.6.1.4 "><p id="p146315654114"><a name="p146315654114"></a><a name="p146315654114"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="27.01%" headers="mcps1.2.6.1.5 "><p id="p12463105694118"><a name="p12463105694118"></a><a name="p12463105694118"></a>CCE集群ID。</p>
</td>
</tr>
<tr id="row1357519417"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.1 "><p id="p104633569415"><a name="p104633569415"></a><a name="p104633569415"></a>nameSpace</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.2 "><p id="p15463135674114"><a name="p15463135674114"></a><a name="p15463135674114"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="14.69%" headers="mcps1.2.6.1.3 "><p id="p7463135619417"><a name="p7463135619417"></a><a name="p7463135619417"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="18.3%" headers="mcps1.2.6.1.4 "><p id="p046312561415"><a name="p046312561415"></a><a name="p046312561415"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="27.01%" headers="mcps1.2.6.1.5 "><p id="p14636564417"><a name="p14636564417"></a><a name="p14636564417"></a>CCE容器集群的命名空间。</p>
</td>
</tr>
<tr id="row458141194116"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.1 "><p id="p34644563419"><a name="p34644563419"></a><a name="p34644563419"></a>appName</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.2 "><p id="p1046455694114"><a name="p1046455694114"></a><a name="p1046455694114"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="14.69%" headers="mcps1.2.6.1.3 "><p id="p1646417563414"><a name="p1646417563414"></a><a name="p1646417563414"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="18.3%" headers="mcps1.2.6.1.4 "><p id="p346495613414"><a name="p346495613414"></a><a name="p346495613414"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="27.01%" headers="mcps1.2.6.1.5 "><p id="p5464956154117"><a name="p5464956154117"></a><a name="p5464956154117"></a>应用名称。</p>
</td>
</tr>
<tr id="row8583124120"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.1 "><p id="p4464456164116"><a name="p4464456164116"></a><a name="p4464456164116"></a>podName</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.2 "><p id="p1046405654119"><a name="p1046405654119"></a><a name="p1046405654119"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="14.69%" headers="mcps1.2.6.1.3 "><p id="p246415684116"><a name="p246415684116"></a><a name="p246415684116"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="18.3%" headers="mcps1.2.6.1.4 "><p id="p446425615412"><a name="p446425615412"></a><a name="p446425615412"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="27.01%" headers="mcps1.2.6.1.5 "><p id="p0464156124117"><a name="p0464156124117"></a><a name="p0464156124117"></a>容器实例名称。</p>
</td>
</tr>
<tr id="row3589174118"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.1 "><p id="p1346485684110"><a name="p1346485684110"></a><a name="p1346485684110"></a>pathFile</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.2 "><p id="p1464556124112"><a name="p1464556124112"></a><a name="p1464556124112"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="14.69%" headers="mcps1.2.6.1.3 "><p id="p346414567413"><a name="p346414567413"></a><a name="p346414567413"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="18.3%" headers="mcps1.2.6.1.4 "><p id="p94643560414"><a name="p94643560414"></a><a name="p94643560414"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="27.01%" headers="mcps1.2.6.1.5 "><p id="p1346411563411"><a name="p1346411563411"></a><a name="p1346411563411"></a>日志文件名称。</p>
</td>
</tr>
<tr id="row185814154115"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.1 "><p id="p114644563419"><a name="p114644563419"></a><a name="p114644563419"></a>hostIP</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.6.1.2 "><p id="p19464115634111"><a name="p19464115634111"></a><a name="p19464115634111"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="14.69%" headers="mcps1.2.6.1.3 "><p id="p1446435694119"><a name="p1446435694119"></a><a name="p1446435694119"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="18.3%" headers="mcps1.2.6.1.4 "><p id="p14464155694117"><a name="p14464155694117"></a><a name="p14464155694117"></a>-</p>
</td>
<td class="cellrowborder" valign="top" width="27.01%" headers="mcps1.2.6.1.5 "><p id="p6464256204118"><a name="p6464256204118"></a><a name="p6464256204118"></a>日志所在虚拟机IP。</p>
</td>
</tr>
</tbody>
</table>
...
请求消息头（Header）如[表4](#zh-cn_topic_0137629939_table17428844137)所示。
...
响应参数如[表5](#zh-cn_topic_0137629939_table6943113915268)所示。
...
<td class="cellrowborder" valign="top" width="33.673367336733676%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0137629939_p10637125431912"><a name="zh-cn_topic_0137629939_p10637125431912"></a><a name="zh-cn_topic_0137629939_p10637125431912"></a>应用名称。</p>
</td>
</tr>
...
-   正常
    ...
    状态码如[表6](#zh-cn_topic_0137629939_table540495445711)所示。
...
-   异常
    ...
    状态码如[表7](#zh-cn_topic_0137629939_table939134985614)所示。更多状态码请见[状态码](状态码.md)。
