...
2.  在左侧导航栏中选择“日志管理 \> 分词配置”。
3.  配置分词。

    AOM提供了如下两种配置分词的方法。若同时使用了这两种配置方法，则分词符取并集。

    -   自定义分词符：单击![](figures/zh-cn_image_0139155787.png)，在文本框中输入分词符，单击![](figures/zh-cn_image_0139155789.png)。
    -   使用ASCII码：单击“添加特殊分词符”，参考[ASCII码对照表](#section15661144724914)输入ASCII值，单击![](figures/zh-cn_image_0139155791.png)。

4.  预览分词效果。

    在文本框中输入待预览的日志内容，单击“预览”。例如，分词符设置为**,\[\]**预览效果如下图所示：

    ![](figures/zh-cn_image_0139155793.png)
